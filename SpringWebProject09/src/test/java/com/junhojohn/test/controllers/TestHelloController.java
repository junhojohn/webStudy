...
public class TestHelloController {
	...
	private String viewName = "/test/testView.jsp";
	...
	public String testView05(@RequestParam(value="abc", defaultValue="1") int no, @RequestParam(value="def", required=false) String name) {
