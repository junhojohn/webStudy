...
public class LoginPoolDataSourceServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		UserPoolDataSourceDao dao = new UserPoolDataSourceDao();
		dao.getUserVO(userVO);
		...
		out.println("<p><p><a href='LoginPoolDataSourceServlet.html'>Back</a>");
		out.println("</body>");
		out.println("</html>");
