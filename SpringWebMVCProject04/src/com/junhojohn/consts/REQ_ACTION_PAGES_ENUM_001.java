...
public enum REQ_ACTION_PAGES_ENUM_001 {
	...
	REQ_HOME		("home", 		"/001views/home.jsp", 			"/SpringWebMVCProject04/home.do"),
	REQ_LOGON		("logon", 		"/001views/logon.jsp", 			"/SpringWebMVCProject04/logon.do"),
	REQ_LOGOUT		("logout", 		"/001views/logout.jsp", 		"/SpringWebMVCProject04/logout.do"),
	REQ_LOGON_ACTION("logonAction", "/001views/logonAction.jsp", 	"/SpringWebMVCProject04/logonAction.do");
