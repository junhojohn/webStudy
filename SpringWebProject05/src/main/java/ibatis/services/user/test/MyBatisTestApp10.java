...
public class MyBatisTestApp10 {
	...
	public static void main(String[] args) throws Exception{
		...
		User user = new User("user04","주몽","user04",10,0);
		...
		System.out.println(":: "+sqlSession.selectOne("userMapper10.getUser",user.getId()) );
		System.out.println("\n");
		...
		System.out.println(":: 5. Use10.deleteUser (DELETE)  ? ");
		System.out.println(":: "+sqlSession.delete("userMapper10.deleteUser", 
																						   user.getId()) );
		System.out.println("\n");
		System.out.println("/////////////////////////////////////////////////////////////////////////////////////////////////");
		System.out.println("\n");
		...
		search.setNameList( new String[]{ "이순신"} );
